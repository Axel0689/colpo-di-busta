# Affari Tuoi · Simulatore Strategico

Simulatore del gioco televisivo "Affari Tuoi", fedele al regolamento
ufficiale edizione 2025/2026. Un solo file HTML, nessuna dipendenza esterna
da installare, pronto per essere pubblicato come sito statico.
...
1. Tabellone ufficiale a 20 pacchi, con i valori reali dell'edizione 2025/2026.
2. Pacco Nero, il cui contenuto viene sorteggiato in modo indipendente e resta segreto anche al Dottore finché non viene aperto.
3. Quattro varianti del Dottore: offerta classica, cambio diretto, "Cambio o Offerta" e "Le Carte".
4. Premio minimo garantito da 1 a 49 euro, portato automaticamente a 50 euro.
5. Minigioco "La Regione Fortunata" nella finalissima, con due turni di indovinelli.
6. "Trova Gennarino", con jackpot progressivo tra una partita e l'altra.
...
Codice distribuito con licenza MIT, salvo diversa indicazione. Nome, formato
e regolamento del programma televisivo "Affari Tuoi" restano di proprietà
dei rispettivi titolari; questo repository non ne rivendica alcun diritto.
